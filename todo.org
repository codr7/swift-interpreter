* debug missing argument in check/evaluate case
** works with parens around expr

* debug left over stack values in closure

* commit tests

* rename DataType to BasicType

* convert = back to function
** add ValueType.isa()
*** add BasicType.parentTypes
** add is? nacro

* add UserFunction subclass
** move pcs
** init with form
** add emit func
